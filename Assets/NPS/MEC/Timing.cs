...
public static class MECExtensionMethods2
{
    ...
    {
        yield return com.unimob.mec.Timing.WaitForSeconds(timeToDelay);
    ...
    {
        while (com.unimob.mec.Timing.MainThread != System.Threading.Thread.CurrentThread ||
    ...
    {
        while (com.unimob.mec.Timing.MainThread != System.Threading.Thread.CurrentThread || (gameObject1 && gameObject1.activeInHierarchy &&
    ...
    public static IEnumerator<float> CancelWith(this IEnumerator<float> coroutine, System.Func<bool> condition)
    {
        ...
        while (com.unimob.mec.Timing.MainThread != System.Threading.Thread.CurrentThread || (condition() && coroutine.MoveNext()))
            yield return coroutine.Current;
    }
    ...
    {
        while (com.unimob.mec.Timing.MainThread == System.Threading.Thread.CurrentThread && gameObject)
        {
            ...
            {
                yield return com.unimob.mec.Timing.WaitForOneFrame;
            }
        }
    }
    ...
    {
        while (com.unimob.mec.Timing.MainThread == System.Threading.Thread.CurrentThread && gameObject1 && gameObject2)
        {
    ...
    public static IEnumerator<float> PauseWith<T>(this IEnumerator<float> coroutine, T script) where T : MonoBehaviour
    {
        ...
        while (com.unimob.mec.Timing.MainThread == System.Threading.Thread.CurrentThread && myGO && myGO.GetComponent<T>() != null)
        {
    ...
    /// <returns>The modified coroutine handle.</returns>
    public static IEnumerator<float> KillWith(this IEnumerator<float> coroutine, com.unimob.mec.CoroutineHandle otherCoroutine)
    {
    ...
    {
        return Superimpose(coroutineA, coroutineB, com.unimob.mec.Timing.Instance);
    }
    ...
    /// <returns>The modified coroutine handle.</returns>
    public static IEnumerator<float> Superimpose(this IEnumerator<float> coroutineA, IEnumerator<float> coroutineB, com.unimob.mec.Timing instance)
    {
