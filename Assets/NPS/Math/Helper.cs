    ...
    public static class Helper
    {
        ...
        public static string Show(this double value)
        {
            ...
            for (i = 0; i < ScoreNames.Length; i++)
                if (value < 1000)
                    break;
                else value = System.Math.Floor(value / 100d) / 10d;

            string str = "1";
            for (int j = 0; j < 3 - ScoreNames[i].Length; j++)
                str += "0";

            if (value > Int32.Parse(str))
                result = System.Math.Floor(value).ToString() + ScoreNames[i];
            else
        ...
        /// <summary>
        /// Trả về giá trị ngẫu nhiên trong Vector2
        /// </summary>
